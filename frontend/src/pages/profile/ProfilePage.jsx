...
import { getUserByProfile, updateUser } from "../../utils/service/apiAuth";
...
const ProfilePage = () => {
  ...
  const {
    ...
    queryFn: () => getUserByProfile(username),
  });
  ...
  const { followUnfollow, isFollowing } = useFollow();
    ...
    <>
      <div className="flex-[4_4_0]  border-r border-gray-700 min-h-screen ">
        ...
        <div className="flex flex-col">
              ...
              <div className="flex justify-end px-4 mt-5">
                ...
                {(coverImg || profileImg) && (
                  <button
                    ...
                    onClick={() => updateInfo({ profileImg, coverImg })}
                  >
          ...
          <Posts postsType={feedType} user={user} />
        </div>
      </div>
    </>
  );
